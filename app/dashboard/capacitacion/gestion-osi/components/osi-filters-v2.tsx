...
import { Search, X, Filter, ChevronDown, Calendar, Building2, User, MapPin } from "lucide-react";
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                {filters.ciudad && (
                  <span className="inline-flex items-center px-2 py-1 rounded-full text-xs bg-teal-100 text-teal-800">
                    Ciudad: {cities.find((c) => c.id.toString() === filters.ciudad)?.nombre_ciudad || filters.ciudad}
                  </span>
                )}
                {filters.monthIssued && (
