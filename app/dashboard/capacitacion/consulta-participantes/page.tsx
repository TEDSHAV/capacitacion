  ...
  const handleSearch = async () => {
    ...
    try {
      const response = await fetch(
        `/api/participants/${encodeURIComponent(searchId.trim())}`,
      );
    ...
    <div className="p-6 max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Busque participantes por número de cédula para ver su historial de
          certificados
        </p>
      </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                {participantData.participant.total_records &&
                  participantData.participant.total_records > 1 && (
                    <p className="text-xs text-amber-600 mt-1">
                      Nota: {participantData.participant.total_records}{" "}
                      registros encontrados para esta cédula
                    </p>
                  )}
              </div>
            </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {participantData.statistics.totalCertificates}
                  </p>
                </div>
              </div>
            </div>
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {participantData.statistics.totalHours}
                  </p>
                </div>
              </div>
            </div>
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {participantData.statistics.averageScore}
                  </p>
                </div>
              </div>
            </div>
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {participantData.statistics.uniqueCompaniesCount}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            {participantData.certificates.length === 0 ? (
              <p className="text-gray-500">
                No se encontraron certificados para este participante.
              </p>
            ) : (
              <div className="space-y-4">
                {participantData.certificates.map(
                        ...
                        <div className="flex-1">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
                            ...
                            <div>
                              ...
                              <p className="font-medium">
                                {certificate.empresas?.razon_social || "N/A"}
                              </p>
                            </div>
                            <div>
                              <p className="text-gray-500">Puntuación</p>
                              <p className="font-medium">
                                {certificate.parsed_snapshot?.participante
                                  ?.score ||
                            ...
                            <div>
                              ...
                              <p className="font-medium">
                                {certificate.parsed_snapshot
                                  ?.certificado_detalles?.horas_estimadas ||
