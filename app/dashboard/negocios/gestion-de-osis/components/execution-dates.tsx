...
const ExecutionDates = ({ formData, isEditing, isNew, updateFormData }: ExecutionDatesProps) => {
  return (
    <div className="space-y-3">
      ...
      <div className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div>
            ...
            <input
              ...
              onChange={(e) => updateFormData('nro_sesiones', parseInt(e.target.value) || 1)}
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">Detalle de Sesión</label>
          <textarea
