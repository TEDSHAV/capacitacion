...
export class QRService {
  ...
  static createVerificationData(
    ...
    if (isValid && certificate) {
      ...
      // Extract facilitator data from snapshot
      const facilitatorData = snapshot?.firmas?.facilitator_data || null;
