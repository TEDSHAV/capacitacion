...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      ecc_encabezado: {
        Row: {
          direccion_tentativa: string | null
          fecha_aprobacion: string | null
          honorarios_facilitador: number | null
          horas_totales: number | null
          id: number
          id_ciudad_ejecucion: number | null
          id_ejecutivo_responsable: number | null
          id_estado_ejecucion: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "ecc_encabezado_id_ejecutivo_responsable_fkey"
          ...
          {
            foreignKeyName: "fk_ecc_ciudad"
            columns: ["id_ciudad_ejecucion"]
            isOneToOne: false
            referencedRelation: "cat_ciudades"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "fk_ecc_estado"
            columns: ["id_estado_ejecucion"]
            isOneToOne: false
            referencedRelation: "cat_estados_venezuela"
            referencedColumns: ["id"]
          },
      ...
      facilitadores: {
        ...
        Relationships: [
          {
            foreignKeyName: "facilitadores_id_ciudad_base_fkey"
            columns: ["id_ciudad_base"]
            isOneToOne: false
            referencedRelation: "cat_ciudades"
            referencedColumns: ["id"]
          },
      ...
      tratos: {
        Row: {
          ...
          id: number
          id_contacto: number
          id_empleado_atiende: number | null
          id_empresa: number | null
          id_estatus: number | null
          id_modalidad: number | null
          id_servicio: number | null
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "tratos_id_modalidad_fkey"
            columns: ["id_modalidad"]
            isOneToOne: false
            referencedRelation: "modalidades"
            referencedColumns: ["id"]
